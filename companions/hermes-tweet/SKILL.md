...
## Pair With HyperDirector

Use this companion before HyperDirector when a video brief needs X/Twitter
research, launch monitoring, audience language, trend checks, or approved
publishing steps. Keep the social signal work inside Hermes Tweet tools, then
hand the selected findings to HyperDirector as normal brief inputs.
